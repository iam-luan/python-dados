...
# Configuração Da Pagrina
# Define o titulo da pagina o icone e o layout para ocupar largura inteira.

st.set_page_config(
    page_title='Dashbord de salário na área de Dados',
    page_icon=':bar_chart:',
    layout='wide',
)
...
# O dataframe principal é filtrado com base nas seleções feitas na barra latera.
...
# --- Conteúdo Principal ---
st.title(':game_die: Dashbord de Análise de Salários na Área de Dados')
st.markdown('Explore os dados salariais na área de dadoos nos últimos anos, Utilize os filtros a esquerda para refinar sua análise.')
